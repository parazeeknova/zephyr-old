...
export default function SignupPage() {
  return (
    <div className="relative flex min-h-screen bg-gradient-to-br from-orange-50 to-orange-100">
      ...
      <div className="pointer-events-none absolute bottom-2 left-2 text-8xl font-bold text-orange-500 opacity-50 sm:bottom-4 sm:left-4 sm:text-6xl">
        ZEPHYR.
      </div>
      <div
        className="-z-1 absolute left-0 top-0 hidden h-full w-1/2 bg-cover bg-center opacity-10 lg:block"
