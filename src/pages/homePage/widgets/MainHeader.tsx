...
import OptionNotification from './subWidgets/optionNotification';
import FileNotification from './subWidgets/fileNotification';
import PlainNotification from './subWidgets/plainNotification';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
