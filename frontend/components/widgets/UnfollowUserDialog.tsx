...
import LoadingButton from '../widgets/authPage/LoadingButton';
...
export default function UnfollowUserDialog({ user, open, onClose }: UnfollowUserDialogProps) {
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Are you sure you want to unfollow {user.displayName}? You can always follow them again
            later.
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
          <LoadingButton variant="destructive" onClick={handleUnfollow} loading={isUnfollowing}>
            Unfollow
          </LoadingButton>
