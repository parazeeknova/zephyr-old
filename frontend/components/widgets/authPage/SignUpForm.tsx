...
import { LoadingButton } from '@/CW/authPage/LoadingButton';
import { PasswordInput } from '@/CW/authPage/PasswordInput';
  ...
  return (
    <div>
      <div className="mb-6 text-center text-sm">
        <FlipWords className="font-semibold text-gray-500 sm:text-base" words={texts} />
      </div>
      <Form {...form}>
